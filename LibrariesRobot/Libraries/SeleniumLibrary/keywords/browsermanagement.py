...
from Libraries.SeleniumLibrary.base import keyword, LibraryComponent
from Libraries.SeleniumLibrary.locators import WindowManager
from Libraries.SeleniumLibrary.utils import (is_truthy, is_noney, secs_to_timestr,
                                   timestr_to_secs)
...
class BrowserManagementKeywords(LibraryComponent):
    ...
    def my_open_browser(self, url, browser='firefox', alias=None,
        ...
        if is_truthy(remote_url):
            ...
            self.info("Abrindo browser '%s' no site '%s'." % (browser, url))
